...
"""
Original VOC datasets transform of YOLOX.
"""
class VOCTrainTransform:
    ...
    def __call__(self, image, targets, input_dim):
        ...
        if len(boxes) == 0:
            ...
            image, r_o = self.preproc(image, input_dim)
            return image, targets
        ...
        height, width, _ = image_t.shape
        image_t, r_ = self.preproc(image_t, input_dim)
        # boxes [xyxy] 2 [cx,cy,w,h]
        boxes = xyxy2cxcywh(boxes)
        boxes *= r_
